...
React 18 + TypeScript, built with Vite. The organisation chart uses @xyflow/react
(React Flow) with a dagre layout. No Tailwind or component kit: styling is hand
written CSS with the shared @adsum/tokens design tokens. Deployed to Cloudflare
...
| @xyflow/react (React Flow) | Organigramme interactif | 12.11.2 |
