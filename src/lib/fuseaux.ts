// Reference time zones offered when creating or editing an activity. Default is
// the base's home GMT zone; pick the activity's own zone when it takes place
// elsewhere so members always see it at their own local time.
