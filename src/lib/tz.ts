// Time-zone conversion helpers shared by the activity create and edit forms.
// An activity's times are typed in the activity's own IANA zone, then stored as
// an absolute UTC instant so every member sees them in their own zone.
